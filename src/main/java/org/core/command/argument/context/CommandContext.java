...
public class CommandContext {
     ...
     * @throws NotEnoughArguments       If a optional argument fails and is actually required
     */
    ...
    public <T> T getArgument(ArgumentCommand command, String id) throws NotEnoughArguments {
        ...
        for (CommandArgument<?> arg : arguments) {
            if ((this.commands.length == commandArgument) && (arg instanceof OptionalArgument)) {
                ...
                try {
                    ...
                    missingArguments.add(arg.getId());
                }
                continue;
            }
        ...
        if (!missingArguments.isEmpty()) {
            throw new NotEnoughArguments(missingArguments);
        }
