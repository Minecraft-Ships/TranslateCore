...
public abstract class AbstractSnapshotValue<O, V> implements SnapshotValue<O, V> {
    ...
    public abstract static class AbstractIdentitySnapshotValue<O, V> extends AbstractSnapshotValue<O, V>
            implements SnapshotValue.IdentifySnapshotValue<O, V> {

        private final String id;
        private final String name;

        public AbstractIdentitySnapshotValue(String id, String name, V value, Function<O, V> getter,
