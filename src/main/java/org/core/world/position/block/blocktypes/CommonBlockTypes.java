...
public class CommonBlockTypes {
    ...
    public static final BlockType ACACIA_DOOR = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:acacia_door")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType ACACIA_FENCE = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:acacia_fence")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType ACACIA_FENCE_GATE = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:acacia_fence_gate")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType ACACIA_STAIRS = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:acacia_stairs")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType ACTIVATOR_RAIL = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:activator_rail")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType AIR = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:air")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    ...
    public static final BlockType IRON_ORE = TranslateCore
            ...
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType IRON_TRAPDOOR = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:iron_trapdoor")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    ...
    public static final BlockType OAK_SIGN = TranslateCore
            ...
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType OAK_STAIRS = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:oak_stairs")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType OAK_TRAPDOOR = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:oak_trapdoor")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    ...
    public static final BlockType TRIPWIRE_HOOK = TranslateCore
            ...
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType MOVING_PISTON = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:moving_piston")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType VINE = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:vine")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
    public static final BlockType NOTE_BLOCK = TranslateCore
            .getPlatform()
            .getBlockType("minecraft:note_block")
            .orElseThrow(() -> new IllegalStateException("Failed to find blocktype"));
