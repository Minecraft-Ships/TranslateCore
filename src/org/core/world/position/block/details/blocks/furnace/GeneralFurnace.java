...
public interface GeneralFurnace extends RotateDetails, TiledBlockDetails<FurnaceTileEntity, FurnaceTileEntitySnapshot> {

    @Override
    default Direction[] getFacingDirections(){
        return Direction.withYDirections(FourFacingDirection.getFourFacingDirections());
    }
}
